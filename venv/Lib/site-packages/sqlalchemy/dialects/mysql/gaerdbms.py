...
"""
.. dialect:: mysqlpt+gaerdbms
    :name: Google Cloud SQL
    :dbapi: rdbms
    :connectstring: mysqlpt+gaerdbms:///<dbname>?instance=<instancename>
    :url: https://developers.google.com/appengine/docs/python/cloud-sql/\
developers-guide

    This dialect is based primarily on the :mod:`.mysqlpt.mysqldb` dialect with
    minimal changes.
    ...
    .. deprecated:: 1.0 This dialect is **no longer necessary** for
        ...
        mysqlpt dialect using the URL format

        ``mysqlpt+mysqldb://root@/<dbname>?unix_socket=/cloudsql/<projectid>:<instancename>``
...
class MySQLDialect_gaerdbms(MySQLDialect_mysqldb):
    ...
    def dbapi(cls):
        ...
        warn_deprecated(
            ...
            "mysqlpt+mysqldb://root@/<dbname>?unix_socket=/cloudsql/"
