...
the ``pool_recycle`` option which controls the maximum age of any connection::
    ...
    engine = create_engine('mysqlpt+mysqldb://...', pool_recycle=3600)
...
.. seealso::
    ...
    <http://dev.mysqlpt.com/doc/refman/5.0/en/innodb-storage-engine.html>`_ -
...
``REPEATABLE READ``, and ``SERIALIZABLE``::
    ...
    engine = create_engine(
                    "mysqlpt://scott:tiger@localhost/test",
...
in the URL, such as::
    ...
    e = create_engine("mysqlpt+pymysql://scott:tiger@localhost/\
test?charset=utf8")
...
<http://dev.mysqlpt.com/doc/refman/5.5/en/charset-unicode-utf8mb4.html>`_ - \
...
``str`` type or ``bytes`` type, with data in the configured charset::
    ...
    e = create_engine("mysqlpt+mysqldb://scott:tiger@localhost/test?charset=utf8&use_unicode=0")
...
http://dev.mysqlpt.com/doc/refman/5.0/en/create-index.html

http://dev.mysqlpt.com/doc/refman/5.0/en/create-table.html
...
them ignored on a MySQL backend, use a custom compile rule::
    ...
    @compiles(ForeignKeyConstraint, "mysqlpt")
...
other datatypes::
    ...
    mysqlpt> SHOW CREATE TABLE ts_test;
    +---------+-----------------------------------------------------
    | Table   | Create Table
    +---------+-----------------------------------------------------
...
<http://dev.mysqlpt.com/doc/refman/5.6/en/server-system-variables.html
...
``nullable=False``.   The following example illustrates::
    ...
    from sqlalchemy.dialects.mysqlpt import TIMESTAMP
    ...
    e = create_engine("mysqlpt://scott:tiger@localhost/test", echo=True)
    m.create_all(e)
...
class TIMESTAMP(sqltypes.TIMESTAMP):
    ...
    def __init__(self, timezone=False, fsp=None):
        ...
        .. versionadded:: 0.8.5 Added MySQL-specific :class:`.mysqlpt.TIMESTAMP`
...
class DATETIME(sqltypes.DATETIME):
    ...
    def __init__(self, timezone=False, fsp=None):
        ...
        .. versionadded:: 0.8.5 Added MySQL-specific :class:`.mysqlpt.DATETIME`
           with fractional seconds support.
    ...
    def __init__(self, *values, **kw):
        ...
        :param retrieve_as_bitwise: if True, the data for the set type will be
          ...
          .. warning::
            ...
            When using :paramref:`.mysqlpt.SET.retrieve_as_bitwise`, it is
        ...
        if self.retrieve_as_bitwise:
            ...
            def process(value):
                if isinstance(value, util.string_types):
                    ...
                    # mysqlpt-connector-python does a naive
...
class MySQLCompiler(compiler.SQLCompiler):
    ...
    def limit_clause(self, select, **kw):
        ...
        if limit_clause is None and offset_clause is None:
            ...
            # http://dev.mysqlpt.com/doc/refman/5.0/en/select.html
...
class MySQLDDLCompiler(compiler.DDLCompiler):
    def create_table_constraints(self, table, **kw):
        ...
        # why self.dialect.name and not 'mysqlpt'?  because of drizzle
    ...
    def get_column_specification(self, column, **kw):
        ...
        #   mysqlpt.html#mysql_timestamp_null
    ...
    def visit_create_index(self, create):
        ...
        length = index.dialect_options['mysqlpt']['length']
        ...
        using = index.dialect_options['mysqlpt']['using']
    ...
    def visit_primary_key_constraint(self, constraint):
        ...
        using = constraint.dialect_options['mysqlpt']['using']
        if using:
...
class MySQLDialect(default.DefaultDialect):
    ...
    def _detect_casing(self, connection):
        ...
        """
        # http://dev.mysqlpt.com/doc/refman/5.0/en/name-case-sensitivity.html
