...
.. dialect:: mysqlpt+zxjdbc
    :name: zxjdbc for Jython
    :dbapi: zxjdbc
    :connectstring: mysqlpt+zxjdbc://<user>:<password>@<hostname>[:<port>]/\
<database>
    :driverurl: http://dev.mysqlpt.com/downloads/connector/j/
...
class MySQLDialect_zxjdbc(ZxJDBCConnector, MySQLDialect):
    jdbc_db_name = 'mysqlpt'
    jdbc_driver_name = 'com.mysqlpt.jdbc.Driver'
