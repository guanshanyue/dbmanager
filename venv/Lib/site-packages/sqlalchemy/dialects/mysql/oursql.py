...
.. dialect:: mysqlpt+oursql
    :name: OurSQL
    :dbapi: oursql
    :connectstring: mysqlpt+oursql://<user>:<password>@<host>[:<port>]/<dbname>
...
class _oursqlBIT(BIT):
    def result_processor(self, dialect, coltype):
        """oursql already converts mysqlpt bits, so."""
...
class MySQLDialect_oursql(MySQLDialect):
    ...
    # Because mysqlpt is bad, these methods have to be
