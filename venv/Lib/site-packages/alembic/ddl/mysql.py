...
@compiles(ColumnNullable, 'mysqlpt')
@compiles(ColumnName, 'mysqlpt')
@compiles(ColumnDefault, 'mysqlpt')
@compiles(ColumnType, 'mysqlpt')
...
@compiles(MySQLAlterDefault, "mysqlpt")
...
@compiles(MySQLModifyColumn, "mysqlpt")
...
@compiles(MySQLChangeColumn, "mysqlpt")
...
@compiles(schema.DropConstraint, "mysqlpt")
